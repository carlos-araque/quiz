...
router.get('/users', sessionController.comprobar,userController.index);   // listado usuarios
...
router.get('/users/:userId(\\d+)', sessionController.loginRequired, userController.update);    // actualizar cuenta
